...
import { ArrowDown, Users, ShieldCheck, MapPin, Utensils, Star, TrendingUp, DollarSign, BarChart3, Clock, Briefcase, Wrench, Monitor } from "lucide-react";
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section id="hero" className="relative min-h-screen flex items-center justify-center section-padding overflow-hidden">
        ...
        <div className="container mx-auto text-center relative z-10">
          ...
          >
            <h1 className="font-display text-6xl md:text-8xl lg:text-9xl font-extrabold tracking-tighter text-gradient mb-6">
              12 Kool
            </h1>
            ...
            <a
              href="#probleme"
              className="inline-flex items-center gap-2 bg-primary text-primary-foreground font-display font-semibold px-8 py-4 rounded-lg hover:opacity-90 transition-opacity text-lg"
            >
              Découvrir le projet
              <ArrowDown size={20} />
            </a>
      ...
      {/* ═══ MARCHÉ ═══ */}
      <AnimatedSection id="marche" className="bg-secondary/30">
        <div className="container mx-auto max-w-5xl">
            ...
            {[
              {
                icon: "🛒",
                title: "Produit",
                text: "Caravane mobile offrant des plats variés et de qualité, avec score de confiance et avis vérifiés.",
              },
              {
                icon: "💲",
                title: "Prix",
                text: "Entre 15 et 60 DH (boissons et nourriture). Fixation par calcul des coûts + marge ou alignement marché.",
              },
              {
                icon: "📣",
                title: "Promotion",
                text: "Réseaux sociaux + Bouche-à-oreille + Affiches dans écoles et universités.",
              },
              {
                icon: "📍",
                title: "Place",
                text: "Boulevards commerciaux, écoles/universités, places publiques — là où se trouvent nos clients.",
              },
            ].map((item, i) => (
              <FeatureCard key={item.title} icon={item.icon} title={item.title} description={item.text} delay={i * 0.1} />
            ))}
          </div>
        </div>
      </AnimatedSection>
      ...
      {/* ═══ TECHNIQUE ═══ */}
      <AnimatedSection id="technique" className="bg-secondary/30">
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <FeatureCard
              ...
              description="Cuisiniers + personnel de service, formés en hygiène et sécurité alimentaire."
              delay={0}
            />
            <FeatureCard
              icon={<Wrench className="text-primary" size={32} />}
              title="Ressources Matérielles"
              description="Machines de cuisson, réfrigération, électricité, ventilation, stockage."
              delay={0.1}
            />
            <FeatureCard
              icon={<Monitor className="text-primary" size={32} />}
              title="Ressources Technologiques"
              description="Logiciels de gestion des commandes, stocks, comptabilité. Plateforme web & mobile pour précommande et géolocalisation."
              delay={0.2}
            />
          </div>
        </div>
      ...
      {/* ═══ FINANCE ═══ */}
      <AnimatedSection id="finance">
        <div className="container mx-auto max-w-5xl">
          <SectionTitle title="Viabilité Financière" />
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
            <StatCard icon="💰" label="Investissement initial" value="190–203K DH" delay={0} />
            <StatCard icon="📈" label="CA mensuel estimé" value="~36 400 DH" delay={0.1} />
            <StatCard icon="📊" label="Bénéfice mensuel" value="10–12K DH" delay={0.2} />
            <StatCard icon="⏱️" label="Retour sur invest." value="18–24 mois" delay={0.3} />
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              {
                title: "Charges fixes",
                text: "Salaires, assurance, internet, entretien — 7 000 à 8 000 DH/mois",
              },
              {
                title: "Charges variables",
                text: "Matières premières (30–40% du CA), gaz, électricité, transport, emballages",
              },
              {
                title: "Financement",
                text: "Apport personnel (80 000 DH) + Crédit bancaire (100 000 DH) + Aide familiale (20 000 DH)",
              },
            ].map((item) => (
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-card border border-border rounded-lg p-8 space-y-4">
              ...
              <ul className="text-muted-foreground space-y-2 text-sm">
                <li><span className="text-primary">●</span> Forme : SARL (plusieurs associés)</li>
                <li><span className="text-primary">●</span> Impôt sur les Sociétés (IS)</li>
                <li><span className="text-primary">●</span> 1 associé salarié gérant (salaire mensuel, CNSS, min. SMIG)</li>
                <li><span className="text-primary">●</span> Autres associés : pas de salaires</li>
              </ul>
            </div>
            <div className="bg-card border border-border rounded-lg p-8 space-y-4">
              <h3 className="font-display text-lg font-semibold flex items-center gap-2">
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
            {[
              ...
              >
                <div className="w-14 h-14 rounded-full bg-primary/10 text-primary font-display font-bold text-xl flex items-center justify-center mx-auto mb-3">
                  {member.first[0]}
                </div>
      ...
      <footer className="border-t border-border py-12 px-4">
        <div className="container mx-auto text-center">
          <p className="font-display text-2xl font-bold text-gradient mb-3">12 Kool</p>
